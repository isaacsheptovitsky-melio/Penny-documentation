...
![Status indicator on top of a Filter button, indicating filters have been applied.](./assets/status-indicator-image-1.png)
...
![Using the Badge component](./assets/status-indicator-image-2.png)
...
![Read only](./assets/status-indicator-image-3.png)

**Read only**

---

![Disabled](./assets/status-indicator-image-4.png)
