...
![Action bar with 1600px and 1200px max widths, respectively.](./assets/action-bar-image-1.gif)
...
![Action bar using background colors inverse and brand, respectively.](./assets/action-bar-image-2.png)
