...
<CardGrid>
  ...
  <LinkCard
    title="Storybook"
    href="https://penny.melio.com/?path=/story/form-form-field--main"
  />
</CardGrid>
...
Form fields on desktop should provide clear visual feedback for focus and validation states. Labels should be properly positioned and helper text should be easily readable. The layout should accommodate various field widths while maintaining consistent spacing.

## Mobile usage and treatment

On mobile devices, form fields should have adequate touch targets and clear visual hierarchy. Error messages should be prominent and actionable, while helper text should remain accessible without overwhelming the interface. Consider the mobile keyboard context for different input types.