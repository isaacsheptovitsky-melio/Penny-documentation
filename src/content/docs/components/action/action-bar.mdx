...
<iframe src="https://penny.melio.com/iframe.html?args=&id=action-components-action-bar-pattern--main&viewMode=story" width="100%" height="500" frameborder="0"></iframe>

<CardGrid>
  <LinkCard title="View in Figma" href="https://zeroheight.com/98bb1df01/v/latest/p/722aae-action-bar" />
  <LinkCard title="View in Storybook" href="https://penny.melio.com/?path=/story/action-components-action-bar-pattern--main" />
</CardGrid>
