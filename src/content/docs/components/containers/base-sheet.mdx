...
<iframe
  src="https://61716025a5ae25003ac448af-kxatgdwswo.chromatic.com/iframe.html?id=containers-base-sheet--bottom&viewMode=story"
  width="100%"
  height="300px"
  frameborder="0"
  allow="clipboard-write"
  style="border: 1px solid #e1e5e9; border-radius: 8px; margin: 16px 0;"
  title="Base Sheet Interactive Example"
></iframe>

<CardGrid>
  <LinkCard
    title="Figma"
    href="https://zeroheight.com/98bb1df01/v/latest/p/692e9d-base-sheet"
  />
  <LinkCard
    title="Storybook"
    href="https://61716025a5ae25003ac448af-kxatgdwswo.chromatic.com/?path=/story/containers-base-sheet--bottom"
  />
</CardGrid>
...
<Aside type="tip">
  Use the Base Sheet for short-to-medium complexity tasks, like making a selection or filling a simple form. For highly complex workflows, such as a **Job**, a full-screen view will provide a better user experience.
</Aside>
...
On desktop, the Base Sheet is typically replaced by Modal or Drawer components that are better suited for larger screen real estate.

## Mobile usage and treatment

The Base Sheet is specifically designed for mobile interfaces where screen space is limited and touch interactions are primary. It provides an ergonomic way to present options and actions that are easily accessible by thumb navigation.
