...
<iframe
  ...
  style="height: 800px; border: 1px solid #e1e5e9; border-radius: 8px; margin: 16px 0;"
...
<CardGrid>
  <LinkCard
    title="Figma"
    href="https://www.figma.com/design/X7oG85653Gwwg7eDTrDUYW/%F0%9F%A4%8D-DS-Components-%F0%9F%A4%8D?node-id=2-73&p=f&t=sxxXCKjrP8C819vO-11"
  />
  <LinkCard
    title="Storybook"
...
_Bill details with attachment drawer_
...
<Aside type="note">
  While the guidelines recommend using the Drawer for quick and lightweight
  secondary tasks, it can also accommodate more complex experiences when such
  complexity is the exception rather than the norm.
</Aside>
