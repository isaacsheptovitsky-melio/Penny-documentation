...
<Aside type="tip">
  ✅ **Melio is ADA-compliant**, meaning our digital experience meets accessibility requirements under U.S. law and follows **[WCAG 2.1 AA standards](https://www.w3.org/WAI/WCAG2AA-Conformance)** to ensure usability for all, including people with disabilities.
</Aside>
...
![Focus order navigation example](/Penny-documentation/foundation/accessibility-assets/focus-order-navigation.gif)
...
![Target size example - Calendar component](/Penny-documentation/foundation/accessibility-assets/target-size-calendar.png)
...
![Nested interactive elements example](/Penny-documentation/foundation/accessibility-assets/nested-interactive-elements.png)
...
![Modal zooming to 400% example](/Penny-documentation/foundation/accessibility-assets/zoom-modal-400percent.gif)
