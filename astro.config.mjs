				...
				},
				{
					...
					items: [
						...
						},
						{
							...
							collapsed: true,
							items: [
								{ label: 'Base Sheet', slug: 'components/containers/base-sheet' },
								...
								{ label: 'Stacked Container', slug: 'components/containers/stacked-container' },
							],
						},
						{
							label: 'Data Display',
							...
							items: [
								...
								{ label: 'Brand Symbol', slug: 'components/data-display/brand-symbol' },
								...
								{ label: 'Flag Icon', slug: 'components/data-display/flag-icon' },
								{ label: 'Pill', slug: 'components/data-display/pill' },
								{ label: 'Section Banner', slug: 'components/data-display/section-banner' },
								{ label: 'Status Indicator', slug: 'components/data-display/status-indicator' },
								...
								{ label: 'Virtual Card', slug: 'components/data-display/virtual-card' },
							],
						},
						{
							label: 'Feedback',
							...
							items: [
								...
								{ label: 'Linear Progress', slug: 'components/feedback/linear-progress' },
						...
						},
						{
							...
							items: [
								...
								{ label: 'Header Cells', slug: 'components/form-table/header-cells' },
						...
						},
						{
							...
							items: [
								...
								{ label: 'Navigation Item', slug: 'components/navigation/navigation-item' },
						...
						},
						{
							...
							collapsed: true,
							items: [
								{ label: 'Amount Field', slug: 'components/selection-inputs/amount-field' },
								{ label: 'Amount Input', slug: 'components/selection-inputs/amount-input' },
								{ label: 'Avatar Image Control', slug: 'components/selection-inputs/avatar-image-control' },
								{ label: 'Calendar', slug: 'components/selection-inputs/calendar' },
								{ label: 'Checkbox', slug: 'components/selection-inputs/checkbox' },
								{ label: 'Combobox', slug: 'components/selection-inputs/combobox' },
								{ label: 'Date Field', slug: 'components/selection-inputs/date-field' },
								{ label: 'Date Picker', slug: 'components/selection-inputs/date-picker' },
								{ label: 'File Attachment', slug: 'components/selection-inputs/file-attachment' },
								{ label: 'File Upload', slug: 'components/selection-inputs/file-upload' },
								{ label: 'Form Field', slug: 'components/selection-inputs/form-field' },
								{ label: 'Large File Upload', slug: 'components/selection-inputs/large-file-upload' },
								{ label: 'Multi Select', slug: 'components/selection-inputs/multi-select' },
								{ label: 'Phone Field', slug: 'components/selection-inputs/phone-field' },
								{ label: 'Radio Group', slug: 'components/selection-inputs/radio-group' },
								{ label: 'Search Bar', slug: 'components/selection-inputs/search-bar' },
								{ label: 'Secured Text Field', slug: 'components/selection-inputs/secured-text-field' },
								{ label: 'Segmented Control', slug: 'components/selection-inputs/segmented-control' },
								...
								{ label: 'Text Area', slug: 'components/selection-inputs/text-area' },
								{ label: 'Text Field', slug: 'components/selection-inputs/text-field' },
								{ label: 'Verification Code Field', slug: 'components/selection-inputs/verification-code-field' },
							],
						},
					],
				},
