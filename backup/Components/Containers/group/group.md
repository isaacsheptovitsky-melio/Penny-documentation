...
![Horizontal (default): Items are laid out in a row.](./assets/group-image-2.png)

**Horizontal (default): Items are laid out in a row.**

---

![Vertical: Items are stacked in a column.](./assets/group-image-3.png)
...
![Turn dividers on/off for visual separation.](./assets/group-image-4.png)
