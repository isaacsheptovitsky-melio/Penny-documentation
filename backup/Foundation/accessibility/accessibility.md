...
![Focus order navigation example](./assets/focus-order-navigation.gif)
...
![Color contrast example](./assets/color-contrast-example.png)
...
![Target size example - Calendar component](./assets/target-size-calendar.png)
...
![Nested interactive elements example](./assets/nested-interactive-elements.png)
...
>![Modal zooming to 400% example](./assets/zoom-modal-400percent.gif)
