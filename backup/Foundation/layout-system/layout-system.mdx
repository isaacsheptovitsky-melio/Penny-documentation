...
<iframe
  src="https://penny.melio.com/iframe.html?id=layout-system--main&viewMode=story"
  width="100%"
  height="300px"
  frameborder="0"
  allow="clipboard-write"
  style="border: 1px solid #e1e5e9; border-radius: 8px; margin: 16px 0;"
  title="Layout System Interactive Example"
></iframe>

<CardGrid>
  <LinkCard title="Figma" href="https://figma.com/layout-system" />
  <LinkCard
    title="Storybook"
    href="https://penny.melio.com/?path=/story/layout-system--main"
  />
</CardGrid>
...
![Layout system overview](/penny-documentation/Foundation/layout-system/assets/layout-system-image-1.png)
...
![Dashboard layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-2.png)
...
![Resources layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-3.png)
...
![Mobile resources layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-4.png)
...
![Resource details layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-5.png)
...
![Job layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-6.png)
...
![Multiple steps layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-7.png)
...
![Settings layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-8.png)
...
![Vendor experience layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-9.png)
...
![Grid layout](/penny-documentation/Foundation/layout-system/assets/layout-system-image-11.png)
...
![Responsive grid example](/penny-documentation/Foundation/layout-system/assets/grid-responsive.gif)
